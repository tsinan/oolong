	  		...
	  		$("input,select,textarea").not("[type=submit]").jqBootstrapValidation({
				submitSuccess: function (form, event) {
					event.preventDefault();
     				...
     				//$.post("advActivity", data, function(d){},"json");
     				request("advActivity", "POST", JSON.stringify(serializeObject(form.serializeArray())));  
 				}
 			});
		})
		            ...
		            <ul class="nav navbar-nav">
						...
						<li class="dropdown">
							...
							<ul class="dropdown-menu">
								<li><a href="advActivity/create">新建广告活动</a></li>
			                  	<li><a href="advActivity/list">查看广告活动</a></li>
			                  	<li class="divider"></li>
      	...
      	<div class="container">
      		<div class="row">
      			...
      			<div class="col-md-10">
					...
					<form id="advActivityForm" class="form-horizontal" novalidate>
			    	<fieldset>
				      	<div id="legend" style="margin-bottom:20px">
			        		<a class="btn btn-default" href="advActivity/list" role="button">
        				...
        				<div class="form-group">
							...
							<div class="col-sm-6 controls">
								<input name="advActivityName" type="text" placeholder="例如：页游广告投放测试" class="form-control input-xlarge" 
